...
class FinanceCategoryController extends Controller
{
    function index(Request $request) {
        ...
        $data = FinanceCategory::when($request->search, function ($query, $search) {
        ...
        return Inertia::render('MasterData/Finance/FinanceCategory', [
            'data' => $data->items(),
            'pagination'  => [
    ...
    function store(Request $request) {
        ...
        if(FinanceCategory::where('name', $request->name)->exists()) return redirect()->back()->with('error', 'Data Already Exists');
    ...
    function update(Request $request, $id) {
        ...
        if(FinanceCategory::where('name', $request->name)->where('id', '!=', $id)->exists()) return redirect()->back()->with('error', 'Data Already Exists');

        $data = FinanceCategory::where('id', $id)->whereNull('deleted_at')->first();
